...
import (
	...
	webhooktoolhivestacklokdevv1alpha1 "github.com/kagenti/kagenti-extensions/toolhive-webhook/internal/webhook/v1alpha1"
...
func main() {
	...
	if os.Getenv("ENABLE_WEBHOOKS") != "false" {
		if err = webhooktoolhivestacklokdevv1alpha1.SetupMCPServerWebhookWithManager(mgr, enableClientRegistration); err != nil {
